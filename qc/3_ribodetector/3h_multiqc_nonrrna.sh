...
#SBATCH --time=0:10:00
#SBATCH --mem=1G
#SBATCH --output=/home/jd2thomp/scratch/microplastics_v2/qc/3_ribodetector/logs/3h_multiqc_nonrrna.%j.log
...
readonly input_dir=${base_dir}/output/rrna_removed/fastqc
