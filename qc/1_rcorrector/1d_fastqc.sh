...
#SBATCH --time=2:00:00
#SBATCH --mem=1G
#SBATCH --output=/home/jd2thomp/scratch/microplastics_v2/qc/1_rcorrector/logs/1d_fastqc.%A_%a.out
#SBATCH --array=0-67
...
readonly input_dir=${base_dir}/output/unfixable_removed
readonly output_dir=${input_dir}/fastqc

#### Input
readonly fastq_files=(${input_dir}/*.fq.gz)
readonly nebnext_adapters=/home/jd2thomp/scratch/microplastics_v2/qc/1_rcorrector/input/nebnext_adapters.tsv
